Now that, you’ve reached the end of this course, you have all the skills you need to build a full single-page ecommerce application with Angular called MyStore -- show product page
